...
func init() {
	file_ibcmiddleware_module_v1_module_proto_init()
	md_Module = File_ibcmiddleware_module_v1_module_proto.Messages().ByName("Module")
}
...
func (x *Module) slowProtoReflect() protoreflect.Message {
	mi := &file_ibcmiddleware_module_v1_module_proto_msgTypes[0]
...
// 	protoc        (unknown)
// source: ibcmiddleware/module/v1/module.proto
...
func (*Module) Descriptor() ([]byte, []int) {
	return file_ibcmiddleware_module_v1_module_proto_rawDescGZIP(), []int{0}
}

var File_ibcmiddleware_module_v1_module_proto protoreflect.FileDescriptor
...
var (
	file_ibcmiddleware_module_v1_module_proto_rawDescOnce sync.Once
	file_ibcmiddleware_module_v1_module_proto_rawDescData = file_ibcmiddleware_module_v1_module_proto_rawDesc
)

func file_ibcmiddleware_module_v1_module_proto_rawDescGZIP() []byte {
	file_ibcmiddleware_module_v1_module_proto_rawDescOnce.Do(func() {
		file_ibcmiddleware_module_v1_module_proto_rawDescData = protoimpl.X.CompressGZIP(file_ibcmiddleware_module_v1_module_proto_rawDescData)
	})
	return file_ibcmiddleware_module_v1_module_proto_rawDescData
}
...
func init() { file_ibcmiddleware_module_v1_module_proto_init() }
func file_ibcmiddleware_module_v1_module_proto_init() {
	if File_ibcmiddleware_module_v1_module_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ibcmiddleware_module_v1_module_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Module); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ibcmiddleware_module_v1_module_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ibcmiddleware_module_v1_module_proto_goTypes,
		DependencyIndexes: file_ibcmiddleware_module_v1_module_proto_depIdxs,
		MessageInfos:      file_ibcmiddleware_module_v1_module_proto_msgTypes,
	}.Build()
	File_ibcmiddleware_module_v1_module_proto = out.File
	file_ibcmiddleware_module_v1_module_proto_rawDesc = nil
	file_ibcmiddleware_module_v1_module_proto_goTypes = nil
	file_ibcmiddleware_module_v1_module_proto_depIdxs = nil
}
