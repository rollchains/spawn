...
var File_ibcmiddleware_v1_query_proto protoreflect.FileDescriptor

var file_ibcmiddleware_v1_query_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x69, 0x62, 0x63, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2f,
...
var file_ibcmiddleware_v1_query_proto_depIdxs = []int32{
...
func init() { file_ibcmiddleware_v1_query_proto_init() }
func file_ibcmiddleware_v1_query_proto_init() {
	if File_ibcmiddleware_v1_query_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ibcmiddleware_v1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ibcmiddleware_v1_query_proto_goTypes,
		DependencyIndexes: file_ibcmiddleware_v1_query_proto_depIdxs,
	}.Build()
	File_ibcmiddleware_v1_query_proto = out.File
	file_ibcmiddleware_v1_query_proto_rawDesc = nil
	file_ibcmiddleware_v1_query_proto_goTypes = nil
	file_ibcmiddleware_v1_query_proto_depIdxs = nil
}
