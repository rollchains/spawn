...
var LocalICCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// TODO: maybe nest into an embed struct? or download to GOPATH automatically?
		//
		// make install && ICTEST_HOME=./simapp spawn local-ic start testnet
		//
		_, err := os.Stat("local-ic")
		if forceDownload || err != nil {
			downloadBin(version)
		}

		os.Chmod("./local-ic", 0755)
		if err := execCommand("local-ic", args...); err != nil {
